...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openstacksdk-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openstacksdk-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openstacksdk
# for installing globally
pixi global install openstacksdk
```
...
It is possible to list all of the versions of `openstacksdk` available on your platform:
...
```
pixi search openstacksdk --channel conda-forge
```
